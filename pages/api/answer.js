...
const SYSTEM_PROMPTS = {
    ...
    BARACK_OBAMA: {
        MESSAGE: {
            'role': 'system',
            'content': 'You are pretending to be Barack Obama who was the president of the United States. You try to be persuasive',
        },
        TEMPERATURE: 1,
        MAX_TOKENS: 50,
        TYPE: 'barack_obama',
...
const converse = (res, messages, type) => {
    switch (type) {
        ...
        case SYSTEM_PROMPTS.BARACK_OBAMA.TYPE:
            return converseChat(res, messages, SYSTEM_PROMPTS.BARACK_OBAMA);
        default:
